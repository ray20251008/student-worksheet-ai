...
# 1. Get 50 chars from git history
# It was in the commit before last in homework_01.html or worksheet_01.html
try:
    old_content = subprocess.check_output(['git', 'show', 'HEAD~1:homework_01/homework_01.html'], cwd=base_dir, text=True, encoding='utf-8')
except subprocess.CalledProcessError:
    # try worksheet_01.html
    old_content = subprocess.check_output(['git', 'show', 'HEAD~1:worksheet_01.html'], cwd=base_dir, text=True, encoding='utf-8')
